...
var LoginPage = /** @class */ (function () {
    //  mode: any = 'Online';
    function LoginPage(menuCtrl, network, http, navCtrl, RestService, alertCtrl, events, platform) {
    ...
    LoginPage.prototype.checkRemember = function (event) {
        this.rememberme = event.target.checked;
    };
    LoginPage.prototype.login = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert_1, alert_2, alert_3, remember, data;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.username == '' || this.username == undefined)) return [3 /*break*/, 3];
                    ...
                    case 2:
                        ...
                        return [2 /*return*/];
                    case 3:
                        if (!(this.password == '' || this.password == undefined)) return [3 /*break*/, 6];
                        return [4 /*yield*/, this.alertCtrl.create({
                                cssClass: 'cstmAlert',
                    ...
                    case 5:
                        ...
                        return [2 /*return*/];
                    case 6:
                        if (!(this.network.type === "none")) return [3 /*break*/, 9];
                        return [4 /*yield*/, this.alertCtrl.create({
                                cssClass: 'cstmAlert',
                    ...
                    case 9:
                        ...
                        this.RestService.loginApi(data).then(function (response) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                            var alert_4;
                            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        this.result = response;
                                        if (!(this.result.Message == "success")) return [3 /*break*/, 1];
                                        if (remember) {
                                        ...
                                        if (this.platform.is('android')) {
                                            JSInterface.startLocationUpdates(JSON.parse(localStorage.userData).Token, JSON.parse(localStorage.userData).Id, localStorage.CompanyUrl);
                                        }
    ...
    LoginPage.prototype.getProfileData = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var Token;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                Token = JSON.parse(localStorage.userData).Token;
                this.RestService.requestViaGet('app/EngineerProfile/GetEngineerProfile/' + Token, '').then(function (response) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                    var profileData, alert_5;
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                this.result = response;
                                if (!(this.result.Message == "success")) return [3 /*break*/, 1];
                                profileData = this.result.result[0];
    ...
    // }
    LoginPage.prototype.viewPass = function () {
