...
var TicketDetailPageRoutingModule = /** @class */ (function () {
    function TicketDetailPageRoutingModule() {
    }
...
var TicketDetailPage = /** @class */ (function () {
    function TicketDetailPage(platform, network, nativeStorage, alertController, zone, transfer, loadingCtrl, file, fileOpener, navCtrl, activatedRoute, RestService) {
    ...
    TicketDetailPage.prototype.ionViewDidLeave = function () {
        this.isStarted = false;
    };
    TicketDetailPage.prototype.getOfflineData = function () {
        var _this = this;
        this.nativeStorage.getItem('offlineAllData')
            .then(function (data) {
            console.log(data);
            // this.events = data.Item1;
            _this.serviceList = data.Item2;
            _this.productList = data.Item3;
        }, function (error) { return console.error(error); });
    };
    TicketDetailPage.prototype.ionViewDidEnter = function () {
        if (localStorage.modeType == 'Offline' && this.network.type == 'none') {
    ...
    TicketDetailPage.prototype.getTimeDiffranceForeman = function () {
        var _this = this;
        var Token = JSON.parse(localStorage.userData).Token;
        this.RestService.requestTimer('app/EngineerTickets/GetTicketTimeDiffrance/' + this.ticketData.Id + '/' + Token, '').then(function (response) {
            _this.apiResponse = response;
            if (_this.apiResponse.Message == "success") {
                _this.isStarted = true;
                _this.times = true;
                _this.TimeSlot = _this.apiResponse.result;
                var IsDays = _this.TimeSlot.split('.').length;
                switch (IsDays) {
                    case 2:
                        _this.TimeSlot = _this.TimeSlot.split('.')[0];
                        break;
                    case 3:
                        _this.TimeSlot = _this.TimeSlot.split('.')[0] + ' Day ' + _this.TimeSlot.split('.')[1];
                        break;
                }
                setTimeout(function () {
                    _this.getTimeDiffranceForeman();
                }, 1000);
            }
            else {
    ...
    TicketDetailPage.prototype.getTimeDiffrance = function () {
        var _this = this;
    ...
    TicketDetailPage.prototype.segmentChanged = function (ev) {
        console.log('Segment changed', ev);
    };
    TicketDetailPage.prototype.start = function () {
                            ...
                            buttons: [
                                ...
                                },
                                {
                                    ...
                                    handler: function () {
                                        ...
                                        _this.isStarted = true;
                                        _this.initTimer();
                                        if (_this.Designation == 2) {
                                            _this.startTicketForreman();
                                        }
                                        else {
                                            _this.startTimer();
                                        }
    ...
    TicketDetailPage.prototype.Stop = function () {
        if (this.Designation == 2) {
    ...
    TicketDetailPage.prototype.StopAll = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                            ...
                            buttons: [
                                {
                                    ...
                                    handler: function (blah) {
                                        ...
                                        _this.isStarted = false;
                                        if (_this.Designation == 2) {
                                            _this.stopTicketForreman();
                                        }
                                        else {
                                            _this.navCtrl.navigateForward('/closer-detail');
                                        }
                                    }
                                },
                                {
    ...
    TicketDetailPage.prototype.stopTicketForremanAlert = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    TicketDetailPage.prototype.stopTicketForreman = function () {
        var _this = this;
        var ticketData = JSON.parse(localStorage.ticket);
        var userData = JSON.parse(localStorage.userData);
        this.RestService.putServices('app/EngineerTickets/stopTicketTimer/' + userData.Id + '/' + ticketData.Id + '/' + userData.Token, '').then(function (response) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            var alert_1;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    TicketDetailPage.prototype.startTicketForreman = function () {
        var _this = this;
        var ticketData = JSON.parse(localStorage.ticket);
        var userData = JSON.parse(localStorage.userData);
        this.RestService.postServices('app/EngineerTickets/startTicketTimerByforeman/' + ticketData.Id + '/' + userData.Id + '/' + userData.Token + '/' + this.validateType, '').then(function (response) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            var alert_2, alert_3;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.apiResponse = response;
                        this.isStarted = true;
                        if (!(this.apiResponse.Message == "success")) return [3 /*break*/, 1];
                        this.serviceList = this.apiResponse.result;
                        this.getTimeDiffranceForeman();
                        return [3 /*break*/, 7];
                    case 1:
                        this.serviceList = this.apiResponse.result;
                        if (!this.serviceList) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.alertController.create({
    ...
    TicketDetailPage.prototype.addNewService = function () {
        this.showServiceForm = true;
    };
    TicketDetailPage.prototype.clientHistory = function () {
        this.navCtrl.navigateForward("/clienthistory");
    };
    TicketDetailPage.prototype.closeServiceAdd = function () {
        this.showServiceForm = false;
    };
    TicketDetailPage.prototype.addProduct = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    TicketDetailPage.prototype.cancelProduct = function () {
        this.showProductForm = false;
    };
    TicketDetailPage.prototype.updateTotalCost = function () {
        if (this.ItemQuantity == '') {
            this.ItemQuantity = 1;
        }
        this.ItemTotalCost = this.ItemQuantity * this.ItemUnitCost;
    };
    TicketDetailPage.prototype.showCloserDetails = function (closerData) {
        console.log(closerData);
        localStorage.setItem('viewCloser', JSON.stringify(closerData));
        this.navCtrl.navigateForward('/view-closer');
    };
    TicketDetailPage.prototype.submitProduct = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var ItemName, alert_4, alert_5, alert_6, alert_7, alert_8, data, Token;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ItemName = '';
                        if (!(this.type == "Product")) return [3 /*break*/, 7];
                        ItemName = this.productName;
                        if (!(this.productName == '' || this.productName == undefined)) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.alertController.create({
                                cssClass: 'cstmAlert',
                    ...
                    case 2:
                        ...
                        return [2 /*return*/];
                    case 3:
                        if (!(this.ItemQuantity == '' || this.ItemQuantity == undefined)) return [3 /*break*/, 6];
                        return [4 /*yield*/, this.alertController.create({
                                cssClass: 'cstmAlert',
                    ...
                    case 7:
                        ...
                        if (!(this.serviceName == '' || this.serviceName == undefined)) return [3 /*break*/, 10];
                        return [4 /*yield*/, this.alertController.create({
                                cssClass: 'cstmAlert',
                    ...
                    case 9:
                        ...
                        return [2 /*return*/];
                    case 10:
                        if (!(this.Designation != 1)) return [3 /*break*/, 16];
                        if (!(this.ItemUnitCost == '' || this.ItemUnitCost == undefined)) return [3 /*break*/, 13];
                        return [4 /*yield*/, this.alertController.create({
                                cssClass: 'cstmAlert',
                    ...
                    case 12:
                        ...
                        return [2 /*return*/];
                    case 13:
                        if (!(this.ItemTotalCost == '' || this.ItemTotalCost == undefined)) return [3 /*break*/, 16];
                        return [4 /*yield*/, this.alertController.create({
                                cssClass: 'cstmAlert',
                    ...
                    case 16:
                        ...
                        if (localStorage.modeType == 'Offline' && this.network.type == 'none') {
                            this.nativeStorage.setItem(ItemName, data).then(function () { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                                return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                            ...
                            this.RestService.postServices('app/EngineerTickets/PostTicketItem/' + Token, data).then(function (response) {
                                console.log(response);
                                _this.apiResponse = response;
                                if (_this.apiResponse.Message == "success") {
                                    _this.getAddedProductList();
                                }
                                else {
                                }
    ...
    TicketDetailPage.prototype.getAddedProductList = function () {
        var _this = this;
        var Token = JSON.parse(localStorage.userData).Token;
        this.RestService.requestViaGet('app/EngineerTickets/GetTicketItem/' + this.ticketData.Id + '/' + Token, '').then(function (response) {
            console.log(response);
            _this.apiResponse = response;
            if (_this.apiResponse.Message == "success") {
                _this.ticketData.TicketItems = _this.apiResponse.result;
            }
            else {
            }
            //  alert(response.MessageDescription);
    ...
    TicketDetailPage.prototype.getKeys = function () {
        var _this = this;
        this.nativeStorage.keys()
            .then(function (data) {
            console.log(data);
            for (var i = 0; i < data.length; i++) {
                _this.getOfflineAddedProductList(data[i]);
            }
        }, function (error) { return console.error(error); });
    };
    TicketDetailPage.prototype.getOfflineAddedProductList = function (key) {
        var _this = this;
        this.nativeStorage.getItem(key)
            .then(function (data) {
            console.log(data);
            if (key.includes("Product") || key.includes("Service")) {
                _this.ticketData.TicketItems.push(data);
            }
        }, function (error) { return console.error(error); });
    };
    TicketDetailPage.prototype.GetCloserAttachmentList = function () {
        var _this = this;
        var CloserID = '';
        var Token = JSON.parse(localStorage.userData).Token;
        this.RestService.requestViaGet('app/EngineerTickets/GetTicketCloserDetails/' + this.ticketData.Id + '/' + Token, '').then(function (response) {
            console.log(response);
            _this.apiResponse = response;
            if (_this.apiResponse.Message == "success") {
                _this.CloserAttachmentList = _this.apiResponse.result;
            }
            else {
            }
            //  alert(response.MessageDescription);
    ...
    /******closer detail view ***************************** */
    TicketDetailPage.prototype.viewCloserDet = function () {
        var _this = this;
        var Token = JSON.parse(localStorage.userData).Token;
        this.RestService.requestViaGet('app/EngineerTickets/GetTicketCloserDetails/' + this.ticketData.Id + '/' + Token, '').then(function (response) {
            _this.apiResponse = response;
            if (_this.apiResponse.Message == "success") {
                _this.closerDetailViewData = _this.apiResponse.result;
                console.log(_this.closerDetailViewData);
            }
            else {
            }
            // alert(response.MessageDescription);
    ...
    //   this.showCloserDetail = false;
    // }
    TicketDetailPage.prototype.getProductList = function () {
        var _this = this;
        var Token = JSON.parse(localStorage.userData).Token;
        this.RestService.requestViaGet('app/EngineerTickets/GetProduct/' + Token, '').then(function (response) {
            console.log(response);
            _this.apiResponse = response;
            if (_this.apiResponse.Message == "success") {
                _this.productList = _this.apiResponse.result;
            }
            else {
            }
            //  alert(response.MessageDescription);
    ...
    TicketDetailPage.prototype.getServiceList = function () {
        var _this = this;
        var Token = JSON.parse(localStorage.userData).Token;
        this.RestService.requestViaGet('app/EngineerTickets/GetService/' + Token, '').then(function (response) {
            console.log(response);
            _this.apiResponse = response;
            if (_this.apiResponse.Message == "success") {
                _this.serviceList = _this.apiResponse.result;
            }
            else {
            }
            // alert(response.MessageDescription);
    ...
    TicketDetailPage.prototype.open = function () {
    };
    TicketDetailPage.prototype.startTimer = function () {
        var _this = this;
        var userData = JSON.parse(localStorage.userData);
        var ticketData = JSON.parse(localStorage.ticket);
        this.RestService.postServices('app/EngineerTickets/StartTicketTimer/' + ticketData.Id + '/' + userData.Id + '/' + userData.Token + '/' + this.validateType, '').then(function (response) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            var alert_9, alert_10;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    TicketDetailPage.prototype.serviceForm = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    //timer work----------->
    TicketDetailPage.prototype.initTimer = function () {
    ...
    TicketDetailPage.prototype.startTime = function () {
        this.runTimer = true;
        this.hasStarted = true;
        this.timerTick();
    };
    TicketDetailPage.prototype.pauseTimer = function () {
        this.runTimer = false;
    };
    TicketDetailPage.prototype.resumeTimer = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    TicketDetailPage.prototype.timerTick = function () {
        var _this = this;
        setTimeout(function () {
            if (!_this.runTimer) {
                return;
    ...
    TicketDetailPage.prototype.getSecondsAsDigitalClock = function (inputSeconds) {
    ...
    //getTicketTimeDiffrance
    TicketDetailPage.prototype.getServiceForm = function () {
        var _this = this;
        var Token = JSON.parse(localStorage.userData).Token;
        this.RestService.requestViaGet('app/EngineerTickets/GetAssignedServiceFormByTicketId/' + this.ticketData.Id + '/' + Token, '').then(function (response) {
            // console.log(response);
            _this.apiResponse = response;
            if (_this.apiResponse.Message == "success") {
                _this.serviceFormData = _this.apiResponse.result;
                console.log(_this.serviceFormData[0]);
            }
            else {
            }
            // alert(response.MessageDescription);
    ...
    TicketDetailPage.prototype.viewForm = function (formID, serviceId, status) {
    ...
    TicketDetailPage.prototype.fileType = function (val) {
    ...
    // }
    TicketDetailPage.prototype.downloadForm = function (MasterServiceFormId, ServiceFormSequenceId, TicketId, EngineerId, closerId) {
        var _this = this;
        this.RestService.requestViaGet('app/EngineerTickets/getServiceFormPDF/' + closerId, '').then(function (response) {
            console.log(response);
            _this.apiResponse = response;
            if (_this.apiResponse.Message == "success") {
                //  var url = 'Documents/ServiceFormPDF/' + ServicePrefix + TicketServiceID + '.pdf';
                // console.log(url)
                _this.downloadCommentFile(_this.apiResponse.MessageDescription);
            }
            else {
            }
            // alert(response.MessageDescription);
    ...
    TicketDetailPage.prototype.downloadCommentFile = function (url) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (this.platform.is('ios')) {
                            fileTransfer.download(this.urlPrefix + url, this.file.documentsDirectory + name).then(function (entry) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                                var alert;
                                return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
...
//# sourceMappingURL=ticket-detail-ticket-detail-module-es5.js.map