...
var DashboardPage = /** @class */ (function () {
    function DashboardPage(events, network, navCtrl, RestService, nativeStorage, platform) {
        this.events = events;
    ...
    DashboardPage.prototype.getOfflineData = function () {
        var _this = this;
        var id = JSON.parse(localStorage.userData).Id;
        var Token = JSON.parse(localStorage.userData).Token;
        this.RestService.requestViaGet('app/EngineerTickets/GetEngineerTicketsForOffline/' + Token, '').then(function (response) {
            console.log(response);
            _this.offlineResponse = response;
            _this.saveOfflineData();
        });
    };
    DashboardPage.prototype.saveOfflineData = function () {
        var _this = this;
    ...
    DashboardPage.prototype.getTotalTickets = function () {
        var _this = this;
        if (this.network.type == 'none') {
            ...
            var id = JSON.parse(localStorage.userData).Id;
            var Token = JSON.parse(localStorage.userData).Token;
            this.RestService.requestViaGet('app/EngineerTickets/DashboardDetails/' + id + '/' + Token, '').then(function (response) {
                console.log(response);
                _this.EngineerTickets = response;
                if (_this.EngineerTickets.Message == "success") {
                    _this.Tickets = _this.EngineerTickets.result;
                    //  localStorage.setItem("fsmdashcount", this.Tickets);
                    if (localStorage.modeType == 'Offline') {
                        _this.nativeStorage.setItem('fsmdashcount', _this.Tickets)
                            .then(function () { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    DashboardPage.prototype.getTickets = function (type) {
