...
var HelpPage = /** @class */ (function () {
    function HelpPage(RestService, location) {
    ...
    HelpPage.prototype.getHelpData = function () {
        var _this = this;
        var Token = JSON.parse(localStorage.userData).Token;
        this.RestService.requestViaGet('app/EngineerProfile/getGenicProfile/' + Token, '').then(function (response) {
            console.log(response);
            _this.response = response;
            if (_this.response.Message == "success") {
                _this.helpData = _this.response.result;
