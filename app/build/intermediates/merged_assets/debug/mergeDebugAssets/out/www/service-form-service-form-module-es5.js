...
var ServiceFormPageRoutingModule = /** @class */ (function () {
    function ServiceFormPageRoutingModule() {
    }
    ...
    return ServiceFormPageRoutingModule;
}());
...
var ServiceFormPageModule = /** @class */ (function () {
    function ServiceFormPageModule() {
    }
...
var ServiceFormPage = /** @class */ (function () {
    function ServiceFormPage(alertCtrl, network, nativeStorage, RestService, navCtrl) {
    ...
    ServiceFormPage.prototype.ngOnInit = function () {
        // if (localStorage.modeType == 'Online') {
        var _this = this;
        // } else 
        this.nativeStorage.getItem('AssignForm').then(function (data) {
            console.log(data);
            _this.offlineAssignFormArr = data;
    ...
    ServiceFormPage.prototype.getOfflineData = function () {
        var _this = this;
        this.nativeStorage.getItem('offlineAllData')
            .then(function (data) {
            console.log(data);
            // this.events = data.Item1;
            _this.serviceFormData = data.Item4;
        }, function (error) { return console.error(error); });
    };
    ServiceFormPage.prototype.getCloserIdForService = function () {
        var _this = this;
        ...
        this.RestService.postServices('/app/EngineerTickets/PostCloserDetails/' + Token, data).then(function (response) {
            ...
            _this.apiServiceResponse = response;
            if (_this.apiServiceResponse.Message == "success") {
                _this.ServicecloserId = _this.apiServiceResponse.result.CloserID;
            }
            else {
            }
        });
    };
    ServiceFormPage.prototype.getItems = function () {
        ...
        return this.serviceFormData = this.serviceFormData.filter(function (v) {
            if (v["FormTitle"].toLowerCase().indexOf(q.toLowerCase()) > -1) {
                return true;
            }
        });
    };
    ServiceFormPage.prototype.getMasterServiceForm = function () {
        var _this = this;
        this.RestService.requestViaGet('app/EngineerTickets/GetMasterServiceForm/' + this.Token, '').then(function (response) {
            console.log(response);
            _this.response = response;
            if (_this.response.Message == "success") {
                _this.serviceFormData = _this.response.result;
                _this.dataArray = _this.response.result;
            }
            else {
            }
        });
    };
    ServiceFormPage.prototype.addForm = function (event, form) {
    ...
    ServiceFormPage.prototype.assignForm = function () {
        var _this = this;
        // var data = [{
        ...
        if (localStorage.modeType == 'Offline' && this.network.type == 'none') {
            ...
            this.nativeStorage.setItem('AssignForm', this.offlineAssignFormArr).then(function () { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            ...
            this.RestService.postServices('app/EngineerTickets/asignServiceformToTicket/' + this.Token, this.submitData).then(function (response) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                var alert_1;
                return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            if (!(this.response.Message == "success")) return [3 /*break*/, 1];
                            this.navCtrl.navigateBack('/ticket-detail');
                            return [3 /*break*/, 3];
    ...
    ServiceFormPage.ctorParameters = function () { return [
...
//# sourceMappingURL=service-form-service-form-module-es5.js.map